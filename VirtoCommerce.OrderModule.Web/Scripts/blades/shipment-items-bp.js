...
.controller('virtoCommerce.orderModule.shipmentItemsBpController', ['$scope', 'platformWebApp.bladeNavigationService', 'platformWebApp.dialogService', function ($scope, bladeNavigationService, dialogService) {
    ...
    console.log('shipment-items-bp.js');
    console.log(blade);
