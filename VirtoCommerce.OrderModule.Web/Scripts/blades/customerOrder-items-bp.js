...
.controller('virtoCommerce.orderModule.customerOrderItemsBpController', ['$scope', 'platformWebApp.bladeNavigationService', 'platformWebApp.dialogService', 'virtoCommerce.catalogModule.items', 'virtoCommerce.pricingModule.prices', '$translate', function ($scope, bladeNavigationService, dialogService, items, prices, $translate) {
